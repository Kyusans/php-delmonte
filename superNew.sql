...
INSERT INTO `tblcandeducbackground` (`educ_back_id`, `educ_canId`, `educ_coursesId`, `educ_institutionId`, `educ_dategraduate`, `educ_diploma_path`) VALUES
(1, 24, 128, 2422, '0000-00-00', '');
...
(1, 24, 'Logistic Officer', 'La Kreativ Events Organizing Services', '02/2024', '03/2025'),
(2, 24, 'Assistant Coordinator', 'La Kreativ Events Organizing Services', '02/2022', '11/2023');
...
(106, 24, 'resumeImage.jpg', '0000-00-00 00:00:00');
...
CREATE TABLE `tblcandskillpoints` (
  ...
  `candSkill_perSId` int(11) NOT NULL,
...
(13, 24, 'Communication', '2025-05-26 17:36:50'),
(14, 24, 'Leadership', '2025-05-26 17:36:50'),
(15, 24, 'Time Management', '2025-05-26 17:36:50'),
(16, 24, 'Coordination', '2025-05-26 17:36:50'),
(17, 24, 'Attention to Detail', '2025-05-26 17:36:50'),
(18, 24, 'Client Relations', '2025-05-26 17:36:50'),
(19, 24, 'Organizing Events', '2025-05-26 17:36:50'),
(20, 24, 'Logistics Planning', '2025-05-26 17:36:50'),
(21, 24, 'Vendor Management', '2025-05-26 17:36:50'),
(22, 24, 'Inventory Management', '2025-05-26 17:36:50'),
(23, 24, 'Event Setup and Breakdown', '2025-05-26 17:36:50'),
(24, 24, 'Programming', '2025-05-26 17:36:50');
...
CREATE TABLE `tblcandtrainpoints` (
  ...
  `candTrain_perTId` int(11) NOT NULL,
...
(128, 'Bachelor of Science in Information Technology', 1, 1, NULL, NULL, NULL);
...
ALTER TABLE `tblcandskillpoints`
  ...
  ADD KEY `candSkill_persId` (`candSkill_perSId`);
...
ALTER TABLE `tblcandtrainpoints`
  ...
  ADD KEY `candTrain_pertId` (`candTrain_perTId`);
...
--
ALTER TABLE `tblcandemploymenthistory`
  MODIFY `empH_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `tblcandresume`
  MODIFY `canres_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=107;
...
--
ALTER TABLE `tblcandskills`
  MODIFY `skills_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
...
--
ALTER TABLE `tblinterviewpassingpercent`
  MODIFY `passing_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
...
--
ALTER TABLE `tbljobpassing`
  MODIFY `passing_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT for table `tbljobseducation`
--
ALTER TABLE `tbljobseducation`
  MODIFY `jeduc_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
...
--
ALTER TABLE `tbljobsmaster`
  MODIFY `jobM_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT for table `tbljobsmasterduties`
--
ALTER TABLE `tbljobsmasterduties`
  MODIFY `duties_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;

--
-- AUTO_INCREMENT for table `tbljobsskills`
--
ALTER TABLE `tbljobsskills`
  MODIFY `jskills_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
...
--
ALTER TABLE `tbljobsworkexperience`
  MODIFY `jwork_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
...
ALTER TABLE `tblcandskillpoints`
  ...
  ADD CONSTRAINT `tblcandskillpoints_ibfk_2` FOREIGN KEY (`candSkill_perSId`) REFERENCES `tblpersonalskills` (`perS_id`);
...
ALTER TABLE `tblcandtrainpoints`
  ...
  ADD CONSTRAINT `tblcandtrainpoints_ibfk_2` FOREIGN KEY (`candTrain_perTId`) REFERENCES `tblpersonaltraining` (`perT_id`);
