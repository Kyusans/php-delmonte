...
class Manager
{
  function getUnfitMedicalCandidates(){
    ...
    $sql = 'SELECT CONCAT(c.cand_lastname, ", ", c.cand_middlename, " ",c.cand_firstname) as cand_fullName, CONCAT(d.hr_lastname, ", ", d.hr_firstname, " ",d.hr_middlename) as hr_fullName,  b.medicalC_type, b.medicalC_name FROM tblmedicalmaster a
