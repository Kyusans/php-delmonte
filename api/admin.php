...
class Admin
{
  ...
  function getPendingCandidates($json)
  {
    ...
    $sql = "SELECT 
                b.cand_id, 
                CONCAT(b.cand_lastname, ', ', b.cand_firstname, ' ', b.cand_middlename) AS FullName,
                b.cand_email, 
                e.status_name,
  ...
  function getAllCandidateQualificationPoints(){
    include "connection.php";
    $totalPoints = 0;
    $appId = 1;
...
switch ($operation) {
  ...
  case "getAllJobQualificationPoints":
    ...
    break;
  case "getAllCandidateQualificationPoints":
    echo json_encode($admin->getAllCandidateQualificationPoints());
    break;
